...
export const Track: React.FC<TrackProps> = ({
  ...
  return (
    <div className="w-full flex flex-col bg-slate-900 rounded-2xl border border-slate-800 p-6 md:p-8 relative overflow-hidden shadow-xl" id="racetrack-container">
      ...
      <div className="relative flex flex-col gap-8 py-4 h-48 justify-center">
        {/* Dashed Finish Line */}
        <div className="absolute right-16 top-0 bottom-0 w-1 border-l-2 border-dashed border-slate-800 pointer-events-none"></div>
